#ifndef BOOST_SIMD_ARCH_ARM_NEON_SIMD_FUNCTION_PACK_CAST_HPP_INCLUDED
#define BOOST_SIMD_ARCH_ARM_NEON_SIMD_FUNCTION_PACK_CAST_HPP_INCLUDED
...
//   };
  ...
  BOOST_DISPATCH_OVERLOAD ( pack_cast_
                          , (typename A0, typename A1)
                          , bs::neon_
                          , bs::pack_<bd::uint16_<A0>,bs::neon64_>
                          , bd::target_<bd::scalar_<bd::uint32_<A1>>>
                          )
  {
    using result = typename A0::template rebind<typename A1::type>;
