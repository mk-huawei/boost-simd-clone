#ifndef BOOST_SIMD_ARCH_ARM_NEON64_SIMD_FUNCTION_SPLAT_HPP_INCLUDED
#define BOOST_SIMD_ARCH_ARM_NEON64_SIMD_FUNCTION_SPLAT_HPP_INCLUDED
...
namespace boost { namespace simd { namespace ext
{
                          ...
                          )
  {
    ...
    {
      return vdup_n_f32( static_cast<float>(v) );
    }
  };
                          ...
                          )
  {
    ...
    BOOST_FORCEINLINE target operator()(Value const& v, Target const&) const BOOST_NOEXCEPT
    {
      return vdup_n_f64( static_cast<double>(v) );
    }
  };
